          ...
          <div className="mb-4 relative">
            ...
            <div className="relative w-[300px]">
              <select
                ...
                className={`block w-full h-[41px] appearance-noneborder border-gray-300 py-2 px-3 pr-8 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm  ${
                  theme === "dark"
                    ? "bg-gray-700 text-white"
                    : " border-gray-300 border text-black"
                }`}
          ...
          {products.length > 0 ? (
            ...
            <div className="col-span-full text-center">
              <p className="text-gray-500 text-lg">
                No products available. Try adjusting your filters or check back
                later!
              </p>
            </div>
          )}
